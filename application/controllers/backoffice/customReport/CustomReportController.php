<?php
    ...
    class CustomReportController extends CI_Controller 
    {
    	...
    	public function index()
    	{
			...
			$countryResult				= $this->CommonModel->getData('ijps_tblcountry','','','','');
			$statusResult				= $this->CommonModel->getData('ijps_tblstatus','','','','');
			$articleResult              = $this->CommonModel->getData('ijps_tblarticle','','','','');
            ...
            $this->load->view(BACKOFFICE.'customReport/seeCustomReport', [
																	'manuscriptResult'		=> $manuscriptResult, 
																	'articalTypeResult' 	=> $articalTypeResult,
																	'countryResult' 	    => $countryResult,
																	'statusResult' 	        => $statusResult,
																	'blogCategoryResult'    => $blogCategoryResult,
																	'articleResult'         => $articleResult,
																	'manuscriptInfoResult'  => $manuscriptInfoResult
																]);
			...
			$employeeResult			= $this->CommonModel->getData('pp_tblemployee','','','','');
			$statusResult			= $this->CommonModel->getData('pp_tblstatus','','','','');
			$cityResult				= $this->CommonModel->getData('pp_tblcity','','','','');
			$busClassResult			= $this->CommonModel->getData('pp_tblbusclass','','','','');
			$flightClassResult		= $this->CommonModel->getData('pp_tblflightclass','','','','');
			$trainClassResult		= $this->CommonModel->getData('pp_tbltrainclass','','','','');
			$cabTypeResult			= $this->CommonModel->getData('pp_tblcabtype','','','','');
			$airportResult			= $this->CommonModel->getData('pp_tblairport','','','','');
			$currencyResult			= $this->CommonModel->getData('pp_tblcurrency','','','','');
			$visaTypeResult			= $this->CommonModel->getData('pp_tblvisatype','','','','');
			$railwayStationResult	= $this->CommonModel->getData('pp_tblrailwaystation','','','','');
            ...
            $this->load->view(BACKOFFICE.'customReport/seeCustomReport', [
																	...
																	'busClassResult'	=> $busClassResult,
																	'flightClassResult'	=> $flightClassResult,
																	'trainClassResult'	=> $trainClassResult,
																	'cabTypeResult'		=> $cabTypeResult,
																	'airportResult'		=> $airportResult,
																	'currencyResult'	=> $currencyResult,
																	'visaTypeResult' 	=> $visaTypeResult,
																	'railwayStationResult' => $railwayStationResult
																]);*/
    	}

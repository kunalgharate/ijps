		...
		<?php
			...
			{
				$formHeading    = "Edit Volume";
				$buttonName     = "Update";
				$url            = 'volume/VolumeController/updateVolume';
			   
			}
			else
			{
				$formHeading    = "Add Volume";
				$buttonName     = "Save";
				$url            = 'volume/VolumeController/insertVolume';
			}
										    ...
										    <div class="col-lg-12" style="display:none;">
										        <div class="form-group">
													<div class="custom-file">
														<input class="form-control" type="hidden" name="txtVolumeID" value="<?php
																																if(isset($volumeResult))
																																{
																																	echo $volumeResult[0]['volumeID'];
																																}
																															?>">
													</div>
												</div>
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="form-group">
													...
													<div class="custom-file">
														<input class="form-control" type="text" name="txtVolumeName" value="<?php
																															if(isset($volumeResult))
																															{
																																echo $volumeResult[0]['volumeName'];
																															}
																														?>" required>
													</div>
												</div>

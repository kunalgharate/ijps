		...
		<?php
			...
			if(isset($blogCategoryResult))
			{
				$formHeading    = "Edit Blog Category";
				$buttonName     = "Update";
				$url            = 'blogCategory/BlogCategoryController/updateBlogCategory';
			   
			}
			else
			{
				$formHeading    = "Add Blog Category";
				$buttonName     = "Save";
				$url            = 'blogCategory/BlogCategoryController/insertBlogCategory';
			}
										    ...
										    <div class="col-lg-12" style="display:none;">
										        <div class="form-group">
													<div class="custom-file">
														<input class="form-control" type="hidden" name="txtBlogCategoryID" value="<?php
																																if(isset($blogCategoryResult))
																																{
																																	echo $blogCategoryResult[0]['blogCategoryID'];
																																}
																															?>">
													</div>
												</div>
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="form-group">
													...
													<div class="custom-file">
														<input class="form-control" type="text" name="txtBlogCategoryName" value="<?php
																															if(isset($blogCategoryResult))
																															{
																																echo $blogCategoryResult[0]['blogCategoryName'];
																															}
																														?>" required>
													</div>
												</div>

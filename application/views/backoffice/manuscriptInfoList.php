    ...
    <div class="card card-custom">
        <div class="card-header py-3">
            <div class="card-title">
                ...
                <h3 class="card-label">All Manuscripts Authors info List</h3>
            </div>
                    ...
                    <table class="table table-bordered" id="list">
                        <thead>
                            <tr role="row">
                                ...
                                <th>Corresponding Author Name</th>
                                <th>Corresponding Author Email</th>
                                <th>Corresponding Author Affiliation</th>
                                <th>Corresponding Author Photo</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody>
...
<style>
    /* Add scroll to modal body */
.modal-scroll {
  max-height: 600px; /* Adjust the maximum height as needed */
  overflow-y: auto;
}
</style>
<div class="modal fade" id="coAuthorDetails" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content ">
     
      <div class="modal-body modal-scroll" id="dynamicContent" style="overflow: auto;">
...
$getCoAuthor = base_url(). BACKOFFICE .'manuscript/ManuscriptController/getCoAuthor';
...
<script>
    ...
    function openModal(statusId, manuscriptId, uniqueCode, titleOfPaper, created_date, email) {
    ...
    table1 = $('#list').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('backoffice/Receviedmanuscript/manuscriptauthorsInfoList') ?>",
            "type": "POST",
            "data": function() {
    ...
    function showCoAuthor(mId){
        $.ajax({
          url: '<?php echo $getCoAuthor; ?>', 
          type: 'POST', 
          data:{mId:mId},
          beforeSend:function(){
            $('#dynamicContent').html('');

		...
		<?php
			...
			{
				$formHeading    = "Edit Newsletter";
				$buttonName     = "Update";
				$url            = 'newsLetter/NewsLetterController/updateNewsletter';
			}
			else
			{
				$formHeading    = "Add Newsletter";
				$buttonName     = "Save";
				$url            = 'newsLetter/NewsLetterController/insertNewsletter';
			}
		?>
					...
					<div class="d-flex align-items-center flex-wrap mr-1">
						<div class="d-flex align-items-baseline flex-wrap mr-5">
							...
							<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
								...
								<li class="breadcrumb-item text-muted">
									<a class="text-muted"> Newsletter</a>
								</li>
								<li class="breadcrumb-item text-muted">
						...
						<div class="col-md-12">
							<div class="card card-custom gutter-b example example-compact">
								...
								<div class="row">
										...
										<div class="row">
											...
											<div class="col-lg-6">
												<div class="form-group">
													...
													<span class="text-danger">*</span></label>
													<div class="custom-file">
														<input class="form-control" type="text" name="txtNewsletterURL" value="<?php
																															if(isset($newsletterResult))
																															{
												...
												<div class="form-group">
													...
													<div class="custom-file">
														<?php
															if(isset($newsletterResult))
															{
																$description  = $newsletterResult[0]['description'];
															}
															else
															{
																$description  ="";
									...
									<div class="col-lg-3">
										<div class="col-lg-12" id="txtThumbnailImageSection">
											<div class="form-group">
												...
												<div class="custom-file">
													<input class="form-control" type="hidden" name="txtThumbnailImage" value="<?php
																														if(isset($newsletterResult))
																														{
																															echo $newsletterResult[0]['thumbnailImage'];
																														}
																													?>">
													...
													<?php
														...
														if(isset($newsletterResult) && $newsletterResult[0]['thumbnailImage'] != "")
														{																
															echo "<a href='".base_url().UPLOAD_NEWSLETTER.$newsletterResult[0]['thumbnailImage']."' target='_BLANK'>
																	<img alt='image' src='".base_url().UPLOAD_NEWSLETTER.$newsletterResult[0]['thumbnailImage']."' width='100px'>
		...
		<script>
			...
			e.preventDefault();
			if(confirm('Are you sure want to add Newsletter?')){

		...
		<?php
			...
			if(isset($cabTypeResult))
			{
				$formHeading    = "Edit Cab Type";
				$buttonName     = "Update";
				$url            = 'cabType/CabTypeController/updateCabType';
			   
			}
			else
			{
				$formHeading    = "Add Cab Type";
				$buttonName     = "Save";
				$url            = 'cabType/CabTypeController/insertCabType';
			}
										    ...
										    <div class="col-lg-12" style="display:none;">
										        <div class="form-group">
													<div class="custom-file">
														<input class="form-control" type="hidden" name="txtCabTypeID" value="<?php
																																if(isset($cabTypeResult))
																																{
																																	echo $cabTypeResult[0]['cabTypeID'];
																																}
																															?>">
													</div>
												</div>
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="form-group">
													...
													<div class="custom-file">
														<input class="form-control" type="text" name="txtCabTypeName" value="<?php
																															if(isset($cabTypeResult))
																															{
																																echo $cabTypeResult[0]['cabTypeName'];
																															}
																														?>" required>
													</div>
												</div>

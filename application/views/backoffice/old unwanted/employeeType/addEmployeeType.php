		...
		<?php
			...
			if(isset($employeeTypeResult))
			{
				$formHeading    = "Edit Employee Type";
				$buttonName     = "Update";
				$url            = 'employeeType/EmployeeTypeController/updateEmployeeType';
			   
			}
			else
			{
				$formHeading    = "Add Employee Type";
				$buttonName     = "Save";
				$url            = 'employeeType/EmployeeTypeController/insertEmployeeType';
			}
		?>
					...
					<div class="d-flex align-items-center flex-wrap mr-1">
						<div class="d-flex align-items-baseline flex-wrap mr-5">
							...
							<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
								...
								<li class="breadcrumb-item text-muted">
									<a class="text-muted"> Employee Type</a>
								</li>
								<li class="breadcrumb-item text-muted">
										    ...
										    <div class="col-lg-12" style="display:none;">
										        <div class="form-group">
													<div class="custom-file">
														<input class="form-control" type="hidden" name="txtEmployeeTypeID" value="<?php
																																if(isset($employeeTypeResult))
																																{
																																	echo $employeeTypeResult[0]['employeeTypeID'];
																																}
																															?>">
													</div>
												</div>
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="form-group">
													...
													<div class="custom-file">
														<input class="form-control" type="text" name="txtEmployeeTypeName" value="<?php
																															if(isset($employeeTypeResult))
																															{
																																echo $employeeTypeResult[0]['employeeTypeName'];
																															}
																														?>" required>
													</div>
												</div>

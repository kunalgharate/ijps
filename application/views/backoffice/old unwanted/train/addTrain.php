		...
		<?php
			...
			if(isset($trainResult))
			{
				$formHeading    = "Edit Train";
				$buttonName     = "Update";
				$url            = 'train/TrainController/updateTrain';
			   
			}
			else
			{
				$formHeading    = "Add Train";
				$buttonName     = "Save";
				$url            = 'train/TrainController/insertTrain';
			}
										    ...
										    <div class="col-lg-12" style="display:none;">
										        <div class="form-group">
													<div class="custom-file">
														<input class="form-control" type="hidden" name="txtTrainID" value="<?php
																																if(isset($trainResult))
																																{
																																	echo $trainResult[0]['trainID'];
																																}
																															?>">
													</div>
												</div>
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="form-group">
													...
													<div class="custom-file">
														<input class="form-control" type="text" name="txtTrainName" value="<?php
																															if(isset($trainResult))
																															{
																																echo $trainResult[0]['trainName'];
																															}
																														?>" required>
													</div>
												</div>

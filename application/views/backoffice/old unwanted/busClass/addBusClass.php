		...
		<?php
			...
			if(isset($busClassResult))
			{
				$formHeading    = "Edit Bus Class";
				$buttonName     = "Update";
				$url            = 'busClass/BusClassController/updateBusClass';
			   
			}
			else
			{
				$formHeading    = "Add Bus Class";
				$buttonName     = "Save";
				$url            = 'busClass/BusClassController/insertBusClass';
			}
										    ...
										    <div class="col-lg-12" style="display:none;">
										        <div class="form-group">
													<div class="custom-file">
														<input class="form-control" type="hidden" name="txtBusClassID" value="<?php
																																if(isset($busClassResult))
																																{
																																	echo $busClassResult[0]['busClassID'];
																																}
																															?>">
													</div>
												</div>
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="form-group">
													...
													<div class="custom-file">
														<input class="form-control" type="text" name="txtBusClassName" value="<?php
																															if(isset($busClassResult))
																															{
																																echo $busClassResult[0]['busClassName'];
																															}
																														?>" required>
													</div>
												</div>

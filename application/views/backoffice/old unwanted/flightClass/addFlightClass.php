		...
		<?php
			...
			if(isset($flightClassResult))
			{
				$formHeading    = "Edit Flight Class";
				$buttonName     = "Update";
				$url            = 'flightClass/FlightClassController/updateFlightClass';
			   
			}
			else
			{
				$formHeading    = "Add Flight Class";
				$buttonName     = "Save";
				$url            = 'flightClass/FlightClassController/insertFlightClass';
			}
					...
					<div class="d-flex align-items-center flex-wrap mr-1">
						<div class="d-flex align-items-baseline flex-wrap mr-5">
							...
							<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
								...
								<li class="breadcrumb-item text-muted">
									<a class="text-muted"> Flight Class</a>
								</li>
								<li class="breadcrumb-item text-muted">
										    ...
										    <div class="col-lg-12" style="display:none;">
										        <div class="form-group">
													<div class="custom-file">
														<input class="form-control" type="hidden" name="txtFlightClassID" value="<?php
																																if(isset($flightClassResult))
																																{
																																	echo $flightClassResult[0]['flightClassID'];
																																}
																															?>">
													</div>
												</div>
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="form-group">
													...
													<div class="custom-file">
														<input class="form-control" type="text" name="txtFlightClassName" value="<?php
																															if(isset($flightClassResult))
																															{
																																echo $flightClassResult[0]['flightClassName'];
																															}
																														?>" required>
													</div>
												</div>

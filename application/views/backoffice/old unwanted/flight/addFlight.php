		...
		<?php
			...
			if(isset($flightResult))
			{
				$formHeading    = "Edit Flight";
				$buttonName     = "Update";
				$url            = 'flight/FlightController/updateFlight';
			   
			}
			else
			{
				$formHeading    = "Add Flight";
				$buttonName     = "Save";
				$url            = 'flight/FlightController/insertFlight';
			}
										    ...
										    <div class="col-lg-12" style="display:none;">
										        <div class="form-group">
													<div class="custom-file">
														<input class="form-control" type="hidden" name="txtFlightID" value="<?php
																																if(isset($flightResult))
																																{
																																	echo $flightResult[0]['flightID'];
																																}
																															?>">
													</div>
												</div>
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="form-group">
													...
													<div class="custom-file">
														<input class="form-control" type="text" name="txtFlightName" value="<?php
																															if(isset($flightResult))
																															{
																																echo $flightResult[0]['flightName'];
																															}
																														?>" required>
													</div>
												</div>

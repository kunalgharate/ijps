			...
			<div class="offcanvas-content pr-5 mr-n5">
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<div class="symbol-label" style="background-image:url('<?php echo base_url('assetsbackoffice/images/profile/'.$this->session->userdata('adminprofilePhoto').''); ?>')">
						</div>
						...
						<div class="navi mt-2">
							<a class="navi-item">
								<span class="navi-link p-0 pb-2">
									...
									<span class="navi-text text-muted text-hover-primary"><?php echo $this->session->userdata('mailID'); ?></span>
								</span>
							</a>
							<a href="<?php echo site_url(BACKOFFICE.'LoginController/signOut'); ?>" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</a>
						</div>
					</div>
				</div>
				...
				<div class="navi navi-spacer-x-0 p-0">
					...
					<!--	</div>-->
					<!--</a>-->
					<a href="<?php echo site_url(BACKOFFICE.'LoginController/signOut'); ?>" class="navi-item">
						<div class="navi-link">
							<div class="symbol symbol-40 bg-light mr-3">
								<div class="symbol-label">

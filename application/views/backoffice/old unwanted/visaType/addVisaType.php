		...
		<?php
			...
			if(isset($visaTypeResult))
			{
				$formHeading    = "Edit Visa Type";
				$buttonName     = "Update";
				$url            = 'visaType/VisaTypeController/updateVisaType';
			   
			}
			else
			{
				$formHeading    = "Add Visa Type";
				$buttonName     = "Save";
				$url            = 'visaType/VisaTypeController/insertVisaType';
			}
					...
					<div class="d-flex align-items-center flex-wrap mr-1">
						<div class="d-flex align-items-baseline flex-wrap mr-5">
							...
							<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
								...
								<li class="breadcrumb-item text-muted">
									<a class="text-muted"> Visa Type</a>
								</li>
								<li class="breadcrumb-item text-muted">
										    ...
										    <div class="col-lg-12" style="display:none;">
										        <div class="form-group">
													<div class="custom-file">
														<input class="form-control" type="hidden" name="txtVisaTypeID" value="<?php
																																if(isset($visaTypeResult))
																																{
																																	echo $visaTypeResult[0]['visaTypeID'];
																																}
																															?>">
													</div>
												</div>
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="form-group">
													...
													<div class="custom-file">
														<input class="form-control" type="text" name="txtVisaTypeName" value="<?php
																															if(isset($visaTypeResult))
																															{
																																echo $visaTypeResult[0]['visaTypeName'];
																															}
																														?>" required>
													</div>
												</div>

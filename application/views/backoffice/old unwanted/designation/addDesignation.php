		...
		<?php
			...
			{
				$formHeading    = "Edit Designation";
				$buttonName     = "Update";
				$url            = 'designation/DesignationController/updateDesignation';
			   
			}
			else
			{
				$formHeading    = "Add Designation";
				$buttonName     = "Save";
				$url            = 'designation/DesignationController/insertDesignation';
			}
			//print_r($designationResult);exit;
		?>
					...
					<div class="d-flex align-items-center flex-wrap mr-1">
						<div class="d-flex align-items-baseline flex-wrap mr-5">
							...
							<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
								...
								<li class="breadcrumb-item text-muted">
									<a class="text-muted"> Designation</a>
								</li>
								<li class="breadcrumb-item text-muted">
													...
													<div class="custom-file">
														<select name="cmbDepartmentID" id="cmbDepartmentID" class="form-control form-control-round" required>
																<?php 
																	...
																	{
    																		if($departmentResult[$i]['departmentID'] == $designationResult[0]['departmentID'])
    																		{
												...
												<div class="form-group">
													...
													<div class="custom-file">
														<input class="form-control" type="text" name="txtDesignationName" value="<?php
																															if(isset($designationResult))
																															{
																																echo $designationResult[0]['designationName'];
																															}
																														?>" required>
													</div>
												</div>

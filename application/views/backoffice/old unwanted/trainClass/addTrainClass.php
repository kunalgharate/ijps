		...
		<?php
			...
			if(isset($trainClassResult))
			{
				$formHeading    = "Edit Train Class";
				$buttonName     = "Update";
				$url            = 'trainClass/TrainClassController/updateTrainClass';
			   
			}
			else
			{
				$formHeading    = "Add Train Class";
				$buttonName     = "Save";
				$url            = 'trainClass/TrainClassController/insertTrainClass';
			}
					...
					<div class="d-flex align-items-center flex-wrap mr-1">
						<div class="d-flex align-items-baseline flex-wrap mr-5">
							...
							<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
								...
								<li class="breadcrumb-item text-muted">
									<a class="text-muted"> Train Class</a>
								</li>
								<li class="breadcrumb-item text-muted">
										    ...
										    <div class="col-lg-12" style="display:none;">
										        <div class="form-group">
													<div class="custom-file">
														<input class="form-control" type="hidden" name="txtTrainClassID" value="<?php
																																if(isset($trainClassResult))
																																{
																																	echo $trainClassResult[0]['trainClassID'];
																																}
																															?>">
													</div>
												</div>
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="form-group">
													...
													<div class="custom-file">
														<input class="form-control" type="text" name="txtTrainClassName" value="<?php
																															if(isset($trainClassResult))
																															{
																																echo $trainClassResult[0]['trainClassName'];
																															}
																														?>" required>
													</div>
												</div>

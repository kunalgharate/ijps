		...
		<?php
			...
			if(isset($issueResult))
			{
				$formHeading    = "Edit Issue";
				$buttonName     = "Update";
				$url            = 'issue/IssueController/updateIssue';
			   
			}
			else
			{
				$formHeading    = "Add Issue";
				$buttonName     = "Save";
				$url            = 'issue/IssueController/insertIssue';
			}
										    ...
										    <div class="col-lg-12" style="display:none;">
										        <div class="form-group">
													<div class="custom-file">
														<input class="form-control" type="hidden" name="txtIssueID" value="<?php
																																if(isset($issueResult))
																																{
																																	echo $issueResult[0]['issueID'];
																																}
																															?>">
													</div>
												</div>
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="form-group">
													...
													<div class="custom-file">
														<input class="form-control" type="text" name="txtIssueName" value="<?php
																															if(isset($issueResult))
																															{
																																echo $issueResult[0]['issueName'];
																															}
																														?>" required>
													</div>
												</div>

									...
									<div class="row align-items-center">
										<div class="col">
											<div class="d-none d-lg-block">
												<h1 class="h2 text-white">Shortlisted Profiles</h1>
											</div>
											<!-- Breadcrumb -->
											<nav aria-label="breadcrumb text-white">
												<ol class="breadcrumb breadcrumb-light mb-0">
													<li class="breadcrumb-item"><i class="fa fa-home"></i> <a href="index.php">Home</a></li>
													<li class="breadcrumb-item active" aria-current="page">Shortlisted Profiles</li>
												</ol>
											</nav>
											<!-- End Breadcrumb -->
										</div>
														...
														<table class="mb-2" style="font-size: 12px;">
															<tbody>
																<tr style="border-bottom: 5px solid #971a1e; border-top: 5px solid #971a1e;vertical-align: middle;">
																	<td width="120" height="40" style="padding-left: 5px; text-align:right" class="font-dark">
																		<b>Share :  </b>
																	</td>
																	<td width="120" height="40" style="padding-left: 5px;" class="font-dark">
																	...
																	<td width="120" height="30" style="padding-left: 5px;  text-align:right" class="font-dark"><b>Shortlist : </b></td>
																	<td width="120" height="30" style="padding-left: 5px;" class="font-dark"><a href="#" target="_blank" title=""><i class="fa fa-star-o text-dark heading-4"></i></a></td>
																	<td width="120" height="30" style="padding-left: 5px;  text-align:right" class="font-dark"><b>Intrested ? : </b></td>
																	<td width="120" height="30" style="padding-left: 5px;" class="font-dark"><a href="#" target="_blank" title=""><i class="fa fa-check text-dark heading-4"></i></a></td>
																	<td width="140" height="30" style="padding-left: 5px;  text-align:right" class="font-dark"><b>Get contact details : </b></td>
																	<td width="100" height="30" style="padding-left: 5px;" class="font-dark"><a href="#" target="_blank" title=""><i class="fa fa-envelope text-dark heading-4"></i></a></td>
																</tr>
															</tbody>
														</table>
													</div>

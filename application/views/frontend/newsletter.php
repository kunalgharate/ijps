		...
		?>
			<title>Newsletters | INTERNATIONAL JOURNAL OF PHARMACEUTICAL SCIENCES</title>
			...
			<link rel="canonical" href="https://www.ijpsjournal.com/newsletters">
			...
			<meta property="og:url" content="https://www.ijpsjournal.com/newsletters">
								...
								<div class="single-blog-item">
									<div class="blog-image">
										<a href="<?php echo $newsletterResult[$i]['link']; ?>">
											<img src="<?php echo base_url(UPLOAD_NEWSLETTER.$newsletterResult[$i]['thumbnailImage']); ?>" alt="image">
										</a>
									</div>
									<div class="blog-content">
										<h6>
											<a href="<?php echo site_url('blog-details'); ?>"><?php echo $newsletterResult[$i]['title']; ?></a>
										</h6>
										<div class="mb-3 mt-3">
											<p>
												<?php echo $newsletterResult[$i]['description']; ?>
											</p>
										</div>
										<div class="blog-btn">
											<a href="<?php echo $newsletterResult[$i]['link']; ?>" class="default-btn">Read More <i class="flaticon-plus"></i></a>
										</div>
									</div>
								</div>
							</div>
